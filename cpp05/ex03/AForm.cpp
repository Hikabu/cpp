...
AForm::AForm(const std::string &target) :  _gradeReqmnt(150), _gradeExecReq(150), _target(target)
{
	_indicator = false; // needed for target
}
...
{
	return (out << COLOR_A
				<< "Info about " << AForm.getName() << COLOR_CLEAN
